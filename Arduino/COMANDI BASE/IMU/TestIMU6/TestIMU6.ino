...
/*
  ...
  0.1*(AaccY[0]-AaccY[1])+0.9*(AaccY[2]/(2)-AaccY[dim-1]/(dim-1))
*/
  //accX *= (1-d);
  //accY *= (1-d);
  //accZ *= (1-d);
  ...
  //accY -=accError*sin(angY*3.1415/180);
...
/*
  Serial.print((AaccY[0]-AaccY[1])+2);
  Serial.print(' ');
  Serial.print((AaccY[2]/(2)-AaccY[dim-1]/(dim-1))+2);
  Serial.print(' ');
  Serial.print(0.1*(AaccY[0]-AaccY[1]));
  Serial.print(' ');
  Serial.println(0.9*(AaccY[2]/(2)-AaccY[dim-1]/(dim-1)));
*/
  Serial.print(speY);
  Serial.print(' ');
  Serial.print(AaccY[dim-1]*10/(dim-1));
  Serial.print(' ');
  Serial.println(accY*10);
