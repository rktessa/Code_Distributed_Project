...
/*
*
* Modified to add acceleration methods
*
* 2017/02/01
*
*/
 ...
 */
GyroAcc::GyroAcc(void) : MePort(0)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
}

/**
 * Alternate Constructor which can call your own function to map the GyroAcc to arduino port,
 * no pins are used or initialized here, but PWM frequency set to 976 Hz
 * \param[in]
 *   port - RJ25 port from PORT_1 to M2
 */
GyroAcc::GyroAcc(uint8_t port) : MePort(port)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
}
 ...
 */
GyroAcc::GyroAcc(uint8_t port, uint8_t address) : MePort(port)
{
 ...
 */
GyroAcc::GyroAcc(uint8_t AD0, uint8_t INT)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
  _AD0 = AD0;
  _INT = INT;
 ...
 *   address - the i2c address you want to set
 */
GyroAcc::GyroAcc(uint8_t AD0, uint8_t INT, uint8_t address)
{
  Device_Address = address;
  _AD0 = AD0;
  _INT = INT;
 ...
 */
void GyroAcc::setpin(uint8_t AD0, uint8_t INT)
{
  _AD0 = AD0;
  _INT = INT;
#ifdef ME_PORT_DEFINED
 ...
 *   None
 */
uint8_t GyroAcc::getDevAddr(void)
{
 ...
 *   None
 */
double GyroAcc::getGyroY(void)
{
  return gyrY;
}

double GyroAcc::getGyroZ(void)
{
  return gyrZ;
}
 ...
 *   Z-axis angle value is integral of Z-axis angular velocity.
 */
double GyroAcc::getAngle(uint8_t index)
{
  update();
  if(index == 1)
  {
...
*
*/
  int16_t GyroAcc::getAccX(void){return accX;}
  int16_t GyroAcc::getAccY(void){return accY;}
  int16_t GyroAcc::getAccZ(void){return accZ;}
 ...
 */
void GyroAcc::deviceCalibration(void)
{
  int8_t return_value;
  uint16_t x = 0;
  uint16_t num = 500;
 ...
 */
int8_t GyroAcc::writeReg(int16_t reg, uint8_t data)
{
 ...
 */
int8_t GyroAcc::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
 ...
 */
int8_t GyroAcc::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
  Wire.beginTransmission(Device_Address);
  return_value = Wire.write(start); 
