...
{   static unsigned long  last_time = 0;
    ...
    gyrX1 = ( ( (i2cData[8] << 8) | i2cData[9] ) );
    gyrY1 = ( ( (i2cData[10] << 8) | i2cData[11] ) );
    gyrZ1 = ( ( (i2cData[12] << 8) | i2cData[13] ) ); 
...
{   static unsigned long  last_time = 0;
    ...
    /* read imu data */
    return_value = readData(0x3b, i2cData, 14);
    return_value1 = readData(0x43, i2cData2, 6);
    ...
    accY = ( (i2cData[2] << 8) | i2cData[3] );
    accZ = ( (i2cData[4] << 8) | i2cData[5] );
    accX1 = ( (i2cData2[0] << 8) | i2cData2[1] );
    accY1 = ( (i2cData2[2] << 8) | i2cData2[3] );
    accZ1 = ( (i2cData2[4] << 8) | i2cData2[5] );
    gyrX1 = ( ( (i2cData[8] << 8) | i2cData[9] ) );
    gyrY1 = ( ( (i2cData[10] << 8) | i2cData[11] ) );
    gyrZ1 = ( ( (i2cData[12] << 8) | i2cData[13] ) );
    gyrX = ( ( (i2cData[8] << 8) | i2cData[9] ) - gyrXoffs) / gSensitivity;
...
double IMU::getGyroX1(void)
{   return gyrX1;   }

double IMU::getGyroY1(void)
{   return gyrY1;   }

double IMU::getGyroZ1(void)
{   return gyrZ1;   } 
...
int16_t IMU::getAccX1(void)
{   return accX1;   }
    
int16_t IMU::getAccY1(void)
{   return accY1;   }
    
int16_t IMU::getAccZ1(void)
{   return accZ1;   }
