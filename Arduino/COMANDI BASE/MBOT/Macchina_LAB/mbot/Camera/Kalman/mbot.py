...
def client_parser(data): 
	global bot, is_point_to_point, ask_go, is_stop_bot, error_counter1, good_data, client, bot_name, name_dir, logger_i,logger_c,logger_f,logger_t, LOG_DATA, SHOW_DATA, server_2,server_1,count_msg2,count_msg, timer,new_time, imu_data, imu_trigger,t_epoch,ard_com_time
	try:
		...
		#camera data parser --> data coming from camera and processed by the server and send to the bot                 
			...
			if imu_trigger > 0.05 :
				...
				encoded1 = data_encoding(accx,accy,omega,t_acq-ard_com_time)
