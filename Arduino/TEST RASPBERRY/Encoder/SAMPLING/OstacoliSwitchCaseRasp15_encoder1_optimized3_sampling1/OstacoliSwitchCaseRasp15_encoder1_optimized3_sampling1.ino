...
float power = 30.0/100; // PRIMO TENTATIVO VEDI VELOCITY PER CORREGGERE VELOCITA'
...
/*MBOT MCORE
  ...
  */
float steeringTime = 700;        //3*360 in 6 s                     //30000.0*1.13/(280*power); //tempo di rotazione a 30 gradi
...
float forwTime = 300 * 1000.0 / (750 * power);  //AVANTI di 1000 mm
