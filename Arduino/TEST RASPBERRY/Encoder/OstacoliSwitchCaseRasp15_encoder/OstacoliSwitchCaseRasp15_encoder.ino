...
float power = 30.0/100; // 50 % potenza
...
if(collision==0){
    ...
    if(accT<accSensitivity*power*resamotori||nStop>600/sampTime){//accSensitivity*power*resamotori

      if(nStop>600/sampTime){
        collision=1;
        n=0;
