...
const int sampTime = 1; //tempo in millis tra una lettura e l'altra
...
void motion_loop(){
  ...
  AaccX[0] = a.acceleration.x*accError - 9.81*sin(angX*3.1415/180) ;
  AaccY[0] = a.acceleration.y*accError - 9.81*sin(angY*3.1415/180) ;
  AaccZ[0] = a.acceleration.z*accError - 9.81*cos(angX*3.1415/180)*cos(angY*3.1415/180);
...
if(distStop>60){
  ...
  */ 
  ...
  Serial.print(accY);
  Serial.print(' ');
  Serial.println(AaccX[dim-1]/(dim-1));
