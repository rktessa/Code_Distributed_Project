...
/*
    ...
    */
    ...
    if(sqrt((speStop-speT)*(speStop-speT))<0.03&&speT<(velocity/2)){
      nStop++;
      obstacle =1;
      distStop =30;
    }else{
...
*/
    /*
    Serial.print("speStop : ");
   Serial.print(speStop);
   Serial.print("  nStop : ");
      Serial.println(nStop);
   */
    if(nStop==round(500/cycleTime)||nStop==6){
      /*
      Serial.print("nStop : ");
      Serial.println(nStop);
      */
...
/*
    //if(ultraSensor.distanceCm() > 60&&ultraSensor.distanceCm() < 200||ultraSensor.distanceCm()>360){
    if(ultraSensor.distanceCm()>360||speT<0.08||speT>1&&speT<3){
      Serial.print("distance : ");
      Serial.println(ultraSensor.distanceCm() );
      tempo = 0;
      ...
      //ultSens = ultraSensor.distanceCm();
      //delay(500);
      //while(tempo < 20&&ultSens==ultraSensor.distanceCm()){
      while(tempo < 8&&speT<0.08||tempo < 8&&speT>1&&speT<3){
        delay(50);
        //ultSens = ultraSensor.distanceCm();
        ...
        speX = speX + accX*55/100000;
        speY = speY + accY*55/100000;
        speZ = speZ + accZ*55/100000;
