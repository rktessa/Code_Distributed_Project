...
float power = 80.0/100; // 50 % potenza
...
/*
  ...
  Serial.println("");
  */
  delay(50);//serve per distanziare i due campionamenti, meno di 40 non va bene
  n++;
  ...
  //Serial.println(cycleTime);
    ...
    if(sqrt((speStop-speT)*(speStop-speT))<0.16*velocity){//&&speT<(velocity/2)){
      nStop++;
      obstacle =1;
      distStop =30;
       nSteer=0;
